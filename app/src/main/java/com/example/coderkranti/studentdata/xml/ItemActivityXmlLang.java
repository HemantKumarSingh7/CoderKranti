...
public class ItemActivityXmlLang extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        langlist.add(new Item("XML Notes",R.drawable.c,"Learn step by step "));
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch(position)
                {
                    case 0:
                        ...
                        Intent intent = new Intent(getApplicationContext(), NotesXmlActivity.class);
                        startActivity(intent);
                        break;

                    case 1:
                        Intent intent1=new Intent(getApplicationContext(), InterviewQuestionXml.class);
