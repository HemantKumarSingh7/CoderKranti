...
public class ItemActivityPython extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        langlist.add(new Item("Python Notes",R.drawable.c,"Learn step by step "));
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                switch(position)
                {
                    case 0:
                        ...
                        Intent intent = new Intent(getApplicationContext(), NotesPythonActivity.class);
                        startActivity(intent);
                        break;

                    case 1:
                        Intent intent1=new Intent(getApplicationContext(), ProgramPythonFile.class);
                        startActivity(intent1);
                        break;

                    case 2:
                        Intent intent2 = new Intent(getApplicationContext(), CompilerPython.class);
                        startActivity(intent2);
                        break;
                    case 3:
                        Intent intent3 = new Intent(getApplicationContext(), InterviewQuestionPython.class);
