...
public class AdminSign_Activity extends AppCompatActivity {
    TextView SignText ,loginRedirectText;
    EditText name,email,contactNo,password,confirmpass,adminID;
    Button signupbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginRedirectText.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent=new Intent(AdminSign_Activity.this, Login_Activity.class);
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if(task.isSuccessful()){
                             Toast.makeText(AdminSign_Activity.this,"Sign up successful",Toast.LENGTH_SHORT).show();
                            Intent intent=new Intent(AdminSign_Activity.this, Login_Activity.class);
                            startActivity(intent);
                        }else{
                            Toast.makeText(AdminSign_Activity.this,"Authentication failed:" +task.getException().getMessage(),Toast.LENGTH_SHORT).show();
                        }
